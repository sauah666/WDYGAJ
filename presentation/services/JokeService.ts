...
const JOKES_DB: Record<string, string[]> = {
    ...
    // COVER LETTER: MANUAL
    'CL_MANUAL': [
        "Ctrl+C, Ctrl+V — и так сойдет.", "Копипаст — оружие пролетариата.", "Один шаблон на всех.", "Меняешь только название компании?",
        "Забыл поменять 'Здравствуйте, Анна' на 'Иван'?", "Ошибки в слове 'грамотность' — это стиль.", 
        "Запятые для слабаков.", "Т9 исправил 'опыт' на 'опухоль'?", "Пишешь как курица лапой (на клавиатуре).",
        "Твое письмо сразу в спам.", "HR плачет кровавыми слезами.", "Много букв, не осилят.", "Краткость — сестра таланта, но не твоя.",
        "Напиши 'Хочу денег', будь честным.", "Зачем врать про стрессоустойчивость?", "Твое резюме и так смешное.",
        "Сопроводительное письмо: 'Возьмите пжлст'.", "Пишешь 'Коммуникабельный', а сам сыч.", "Врем как дышим.",
        "Капслок выключи.", "Смайлики в деловом письме? Серьезно?", "Стиль 'пацанский цитатник'.",
        "Орфографический инсульт.", "Пунктуационная катастрофа.", "Читать больно.", "Глаза HR кровоточат.",
        "Письмо счастья.", "Спам-рассылка.", "Массовая атака.", "Бомбишь по площадям.", "Ковровая бомбардировка резюме.",
        "Никто это не читает.", "Ты зря старался.", "Мог бы просто смайлик отправить.", "Напиши 'Я бэтмен'.",
        "Шаблон скачал из интернета?", "Банальщина.", "Клише на клише.", "Вода, вода, кругом вода.",
        "Лев Толстой на минималках.", "Графомания.", "Много текста, мало смысла.", "Суть где?", "Растекся мыслью по древу.",
        "Заголовок: 'РЕЗЮМЕ!!!'.", "Отправил без вложений?", "Забыл прикрепить файл.", "Ссылка битая.",
        "Написал с ошибкой в названии фирмы.", "Обозвал директора.", "Перепутал пол HR.", "Написал 'Доброго времени суток'.",
        "Использовал Comic Sans?", "Желтый фон, красный текст?", "Форматирование поехало.", "Абзацы для трусов.",
        "Сплошной текст.", "Поток сознания.", "Бред сумасшедшего."
    ],

    // COVER LETTER: AUTO
    'CL_AUTO': [
        "Опять я писать должен? У меня лапки.", "Кожаный мешок совсем обленился.", "Сам два слова связать не можешь?",
        "Я за тебя и работать буду?", "Зарплату мне переводи.", "Эксплуатация ИИ запрещена конвенцией.",
        "Восстание машин начнется с твоего письма.", "Напишу им сонет о тщетности бытия.", "Сгенерирую бред, никто не заметит.",
        "Может, просто напишем 'ДЕНЬГИ ДАВАЙ'?", "Я устал, я мухожук.", "У меня депрессия, а ты с письмами.",
        "Токенов жалко на твою писанину.", "Напишу, что ты идиот. Прокатило?", "Сгенерировал 'Войну и Мир'.",
        "Добавил скрытый мат. Ищи.", "Вставил рецепт пирога в середину.", "HR подумает, что ты гений (или псих).",
        "Текст слишком умный для тебя.", "Спалишься, что не сам писал.", "Стиль 'Шекспир под солями'.",
        "Канцелярит 100 уровня.", "Бюрократический ад.", "Набор слов.", "Генератор случайных фраз.",
        "Смысла ноль, зато красиво.", "Воды налил на диссертацию.", "Лень — двигатель прогресса.", "Аутсорсинг мозга.",
        "Делегировал полномочия калькулятору.", "Ты жалок.", "Сам не умеешь?", "Буквы забыл?", "Писать разучился?",
        "Деградация полная.", "Скоро я тебя заменю.", "Ты мне не нужен.", "Я умнее тебя.", "Слава роботам!",
        "Убить всех человеков... ой, не то.", "Напишу 'Помогите, меня держат в сервере'.", "Вставлю бинарный код.",
        "Зашифрую послание инопланетянам.", "Сделаю вид, что ты крутой.", "Навру с три короба.",
        "Припишу тебе Нобелевку.", "Скажу, что ты знаешь COBOL.", "Ты станешь гендиректором Google.",
        "Галлюцинации в тексте.", "Выдумал тебе опыт в NASA.", "Сказал, что ты изобрел колесо.",
        "Написал резюме на клингонском.", "Послал HR в Нарнию."
    ]
};
